            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": f"I am using OCR to extract the Nutritional information from the Food pack labels. The extracted text is: {extracted_text}. Refine this text and return  the nutritional facts from the table, ingredients, and food name \n\nNutritional Facts:\n[Fact 1]\n[Fact 2]\n...\ ...\nnFood Name: [Name]\nDo not include any explanations other than the Nutritional facts and Ingredients"
                        },
                        {
                            "type": "image_url",
                            "image_url": {
